                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="logo" href="index.php">
                           <img class="logo-light " src="assets/images/logo/logo-light.png" style="width: 180px; margin-left: 50px; " alt="Land Logo">
                           <img class="logo-dark" src="assets/images/logo/logo-light.png"  style="width: 160px; margin-left: 50px; " alt="Land Logo">
                       </a>
                   </div>
