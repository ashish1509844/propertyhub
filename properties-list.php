...
include("config.php"); 
    ...
    ?>
        ...
        <!-- properties-list
============================================= -->
<section id="properties-list" class="properties-list" style="padding-top: 1px;padding-bottom: 10px;">
                                    ...
                                    <div class="properties-filter clearfix">
                                        <div class="select--box pull-left">
                                            ...
                                            <select id="selectFilter" name="selectFilter" style="color: white;">
                								...
                								<option  <?php if (@$_GET['selectFilter'] == "Default"){echo "selected";} ?> style="color: black;" value="default">Default Sorting</option>
                                                <option value="latest" <?php if (@$_GET['selectFilter'] == "latest"){echo "selected";} ?>  style="color: black;">Latest</option>
                								<option value="high-price" <?php if (@$_GET['selectFilter'] == "high-price"){echo "selected";} ?>  style="color: black;">Highest Price</option>
                								<option value="low-price" <?php if (@$_GET['selectFilter'] == "low-price"){echo "selected";} ?> style="color: black;">Lowest Price</option>
                                                <option  value="oldest" <?php if (@$_GET['selectFilter'] == "oldest"){echo "selected";} ?> style="color: black;">Oldest</option>
                							</select>
                                        </div>
                                        <!-- .select-box -->
                                        <div class="view--type pull-right">
                                            <a id="switch-list" href="#" class="active"><i class="fa fa-th-list" style="color: #ffffff;"></i></a>
                                            <a id="switch-grid" href="#" class=""><i class="fa fa-th-large" style="color: #64ddbb;"></i></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                               ...
                                               <?php if($q==0)
                                                {?>
                                                    <p class="property--price1" style="font-size: 24px;">
                                                        Rs. <?php 
                                                        echo moneyFormatIndia($result['property_price']);?><p1 style="color: #282828; font-size: 18px;"></p><p1 style="color: #f33408; font-size: 20px;" > Deposite.<?php 
