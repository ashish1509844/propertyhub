...
<!-- #page-title end -->
        ...
        <!-- property single gallery
            ============================================= -->
<section id="property-single-gallery" class="property-single-gallery"style="padding-top: 1px;padding-bottom: 10px;">
                                    ...
                                    <div class="pull-left">
                                        ...
                                        if($q == 2){?>
                                            <ul class="list-unstyled list-inline mb-0">
                                                <li class="pull-left" style="font-size: 30px;"><a  class="edit--btn"><i class="fa fa-shopping-basket"></i> Sold Out</a></li>
                                            </ul>
                                        <?php } else if(@$_SESSION['user_type']==1){ ?>
                                        <ul class="list-unstyled list-inline mb-0">
                                            <li class="pull-left" style="font-size: 30px;"><a href="edit-property.php?id=<?php echo $result['property_id'];?>" class="edit--btn"><i class="fa fa-edit"></i> Edit</a></li>
                                        </ul>
                                        <?php } else if($result['property_status'] == 1){ ?>
                                        <ul class="list-unstyled list-inline mb-0">
                                            <li class="pull-left" style="font-size: 30px;"><a href="buy-property.php?id=<?php echo $result['property_id'];?>" class="edit--btn"><i class="fa fa-shopping-cart"></i> Buy</a></li>
                                        </ul>
                                        <?php } else{ ?>
                                        <ul class="list-unstyled list-inline mb-0">
                                            <li class="pull-left" style="font-size: 30px;"><a href="check-availability.php?id=<?php echo $result['property_id'];?>" class="edit--btn"><i class="fa fa-shopping-cart"></i> Rent</a></li>
                                        </ul>
                                            <?php } ?>
                                    ...
                                    <div class="property-single-carousel-content">
                                        ...
                                        <div class="owl-thumbs thumbs-bg" data-slider-id="1">
                                            <?php 
                                                ...
                                                {
                                                    if(is_file($image)){
                                                        $img =  '<img src='.$image.' height="100px" width="125px">';
                                                    }
                                                    ?>
