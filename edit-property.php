        ...
        { 
          ...
          if($fileErrorChk==1)
          {
            ...
            { 
              ...
              $uploadPath=$serverPath."/uploads/".$fileName;
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                          <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="property-name" value="<?php echo @$result['property_name'];?>" required>
                                          </div>
                                      </div>
                                      <div class="col-xs-12 col-sm-4 col-md-4">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="address" id="property-Address" value="<?php echo @$result['property_address'];?>" required>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="squarefeet" id="property-Squarefeet" value="<?php echo @$result['property_sqfeet'];?>" required>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label1 for="property-Squarefeet">Property Price</label1>
                                                <input type="text" class="form-control" name="price" id="property-price" max="15"placeholder="RS" value="<?php echo @$result['property_price'];?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <?php 
                                          ...
                                          <div class="col-md-2 imgDelete" style="text-align: right;margin-bottom: 30px;">
                                              ...
                                              <?php echo $img;?>
                                              <span style="position: absolute; right: 15px; top: 5px; "><a href="delete_img.php?img_id=<?php echo $image; ?>&pid=<?php echo $_GET['id']; ?>" class="imgDelete" style="border-radius: 50%;padding-right: 4px;padding-left: 4px; background: #f8f9fa;color: red;font-size: 15px;"><i class="fa fa-times"></i></a></span>
                                          </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="property-description" rows="2" value="" required><?php echo @$result['property_description'];?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label1 for="property-totalbeds">Property total bedroom</label1>
                                                <input type="number" class="form-control" name="totalbeds" id="property-totalbeds" value="<?php echo @$result['property_totalbeds'];?>" required>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label1 for="property-totalbaths">Property total baths</label1>
                                                <input type="number" class="form-control" name="totalbaths" id="property-totalbaths" value="<?php echo @$result['property_totalbaths'];?>" required>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label1 for="property-state">Property state</label1>
                                                <input type="text" class="form-control" name="state" id="property-state" value="<?php echo @$result['property_state'];?>" readonly style="background-color:  #aaaaaa;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="text" class="form-control" name="city" id="property-city" value="<?php echo @$result['property_city'];?>" required> -->
                                                  ...
                                                  <select  name="city" id="property-city">
                                                    <option value="<?php echo @$result['property_city'];?>"><?php echo @$result['property_city']; ?></option>
