  ...
  { 
      ...
      if(empty($nameErr) && empty($typeErr) && empty($addressErr)&& empty($squarefeetErr) && empty($priceErr) && empty($descriptionErr) && empty($statusErr) && empty($cityErr) && empty($depositeErr) )
        {    
          ...
          $serverPath=$_SERVER["DOCUMENT_ROOT"]."/propertyhub";
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
             ...
             <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="state" id="property-state" value="Gujarat" readonly style="background-color:  #aaaaaa;">
...
<!-- if(!empty($_REQUEST['name']) && !empty($_REQUEST['type']) && !empty($_REQUEST['address']) && !empty($_REQUEST['squarefeet']) && !empty($_REQUEST['price']) && !empty($_REQUEST['description']) && !empty($_REQUEST['city']) && !empty($_REQUEST['status']) )        
        { -->