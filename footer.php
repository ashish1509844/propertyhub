                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3 widget--about">
                            <div class="widget--content">
                                ...
                                <img class="logo-light " src="assets/images/logo/logo-light.png" style="width: 150px;  " alt="Land Logo">
                                </div>86, Iscon Mega City, Jewel Road, Near Himalya mall, Bhavnagar-364001</p>
                ...
                <div class="container">
                    <div class="row footer--bar">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <span> 2024 Property hub, All Rights Reserved.</span>
                        </div>
